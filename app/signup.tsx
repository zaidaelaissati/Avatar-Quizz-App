          ...
          <CardContent style={{ gap: 24 }}>
            ...
            <View style={{ gap: 8 }}>
              ...
              <View
                ...
                <TextInput
                  ...
                  style={{ flex: 1, color: textColor, paddingVertical: 10 }}
                />
                <Pressable onPress={() => setShowPasswordRepeat(!showPasswordRepeat)}>
                  <Text style={{ fontSize: 18, color: textColor, paddingHorizontal: 8 }}>
                    {showPasswordRepeat ? '👁️' : '👁️'}
                  </Text>
                </Pressable>
              </View>
            </View>
            ...
            <Text style={{ textAlign: 'center', color: textColor }}>
              ...
              <Pressable onPress={() => router.replace('/login')}>
                <Text
                  style={{ color: '#DC2626', textDecorationLine: 'underline', fontWeight: '700' }}>
                  Keer terug naar Login
                </Text>
              </Pressable>
            </Text>
